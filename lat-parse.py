...
# bp = sns.boxplot(data=log, x='label', y='value', estimator="median",
#              ci='sd', err_style='band', palette=palette,
#              hue='layer', hue_order=['flume', 'zenoh-flow-link'])

bp = sns.boxplot(data=log, x='label', y='value', hue='layer', hue_order=['flume', 'zenoh-flow-link'], palette=palette)
...
#fig.savefig(img_dir.joinpath('zenoh-flow-latency-breakdown.png'))

# # ALL throughput
# fig, axes = plt.subplots()

# sns.lineplot(data=log, x='label', y='throughput', estimator="median",
#              ci='sd', err_style='band', palette=palette,
#              hue='scenario', hue_order=['nucleo-f767zi', 'reel_board', 'esp32'])
...
# plt.tight_layout()
# #plt.show()
# fig.savefig(img_dir.joinpath('zenoh_pico_thr_all.png'))
